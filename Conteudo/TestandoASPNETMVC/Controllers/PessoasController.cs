...
namespace TestandoASPNETMVC.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public PessoasController(aulaentityContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Pessoas != null ? 
                          ...
                          Problem("Entity set 'aulaentityContext.Pessoas'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'aulaentityContext.Pessoas'  is null.");
            }
            var pessoa = await _context.Pessoas.FindAsync(id);
            if (pessoa != null)
            {
